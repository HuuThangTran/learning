...
* List.h // FileName
* Headerfile contain the private struct of the ADT and function of the ADT // Describe the program
***/
...
#include <stdbool.h>
    ...
    int listIndex(List L); // Returns index of cursor element if defined, -1 otherlwise.
    ...
    void listClear(List L); // Resets L to its original empty state.
